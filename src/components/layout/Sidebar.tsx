...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-52 shrink-0 flex-col border-r border-white/[0.06] bg-black px-3 py-5">
      {/* Logo */}
      <div className="mb-6 flex items-center gap-2 px-2.5">
        ...
        <span className="text-sm font-semibold tracking-tight text-white">MoLis</span>
      </div>
      ...
      <div className="flex flex-col gap-0.5 border-t border-white/[0.06] pt-3">
        ...
        <button
          ...
          className="flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-white/30 transition-all duration-150 hover:bg-white/[0.06] hover:text-white/50"
        >
